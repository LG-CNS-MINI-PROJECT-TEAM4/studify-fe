...
//     // auth.isAuthed 대신 직접 localStorage 확인
//     const token = localStorage.getItem("accessToken");
//     const userId = localStorage.getItem("userId");

//     console.log("connectWebSocket called - token:", !!token, "userId:", userId);
...
//     if (!userId) {
//       console.log("User ID not found, cannot connect to WebSocket");
//       return;
//     }
...
//           // 사용자별 알림 구독
//           const subscriptionPath = `/topic/notifications/${userId}`;
...
//     if (isAuthed) {
//       console.log("User is authenticated, requesting notification permission and connecting WebSocket");
...
//     const onStorage = (e) => {
//       if (["accessToken", "refreshToken", "userId"].includes(e.key)) {
...
//     const onAuthChanged = () => {
//       console.log("auth-changed event triggered");
//       const newAuthState = loadAuthFromStorage();
//       console.log("New auth state:", newAuthState);
//       if (newAuthState && !isWebSocketConnected) {
//         console.log("Auth changed to true, connecting WebSocket");
//         connectWebSocket();
//       } else if (!newAuthState) {
//         console.log("Auth changed to false, disconnecting WebSocket");
//         disconnectWebSocket();
//         setNotifications([]);
//         setUnreadCount(0);
//       }
